...
Mesh MeshIGAAnnulus(double R, double r, double th, int mref, int porder)
{
    ...
    igaannulus(R,r,th,mref,porder,&bc_periodic,&nelem_global,&knotVector_global,&wVector_global,&XVector_global);
    mesh->porder            = porder;
