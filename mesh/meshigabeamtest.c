...
Mesh MeshIGABeamTest(double Lx, double Ly, double Lz, int mref, int porder, int bc_periodic_x, int bc_periodic_y, int bc_periodic_z)
{
    ...
    igabeamtest(Lx,Ly,Lz,mref,porder,bc_periodic_x,bc_periodic_y,bc_periodic_z,&bc_periodic,&nelem_global,&knotVector_global,&wVector_global,&XVector_global);
    mesh->porder            = porder;
